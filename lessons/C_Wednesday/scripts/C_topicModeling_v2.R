...
# alpha - there is a distribution of the probabilities of how similar they are to each other
# eta   - there is also a distribution of probabilities for the number of topics inside a single document
# 
...
topFive <- apply(topFive,2,paste, collapse=' ') #collapse each of the single topics word into a single "name"
