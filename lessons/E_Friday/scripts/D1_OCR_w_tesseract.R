...
#' 
## WARNING: Tesseract is an optical character recognition engine for various operating systems. It is free software, released under the Apache License, Version 2.0, and development has been sponsored by Google since 2006. THE R PACKAGE INSTALLS THE TESSERACT SOFTWARE & IS BLOCKED ON THE FREE CLOUD SERVER so use this script locally or on a server you can configure.
